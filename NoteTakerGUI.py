...
class MyForm(wx.Frame):
    ...
    def __init__(self):
        ...
        self.openBtn = wx.Button(self.panel, label= "View Sheet Music")
        ...
        self.sizer.Add(self.openBtn, 0 , wx.CENTER, 0)
...
#----------------------------------------------------------------------
    ...
    def run(self, event):
        ...
        if filePath == "":
            ...
            self.openBtn.Show()
            subprocess.call(["/Applications/LilyPond.app/Contents/Resources/bin/lilypond", "sheet.ly"])
            #self.sizer.Add(self.openBtn, 0 , wx.CENTER, 0)
    ...
    def open(self, event):
        subprocess.check_call(['open', 'sheet.pdf'])
